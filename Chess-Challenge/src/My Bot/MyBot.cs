...
public class MyBot : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        foreach (Move move in moves)
        {
            ...
            eval = ApplyEvalRules(move, eval, board);
    ...
    /// <summary>
    /// Apply rules that change the evaluation. Rules would include stuff like:
    ///  - Queen moves should be done less likely in the opening
    ///  - Rock moves should be done less likely in the opening
    ///
    ///  This approach was chosen to allow a super small network (64 input nodes,
