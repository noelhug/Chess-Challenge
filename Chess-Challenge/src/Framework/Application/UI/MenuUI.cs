...
namespace ChessChallenge.Application
{
    public static class MenuUI
    {
        public static void DrawButtons(ChallengeController controller)
        {
            ...
            // Game Buttons
            if (NextButtonInRow("MyBot vs SFBot", ref buttonPos, spacing, buttonSize))
            {
                controller.StartNewBotMatch(ChallengeController.PlayerType.MyBot, ChallengeController.PlayerType.SFBot);
            }
            if (NextButtonInRow("MyBot vs TestBot", ref buttonPos, spacing, buttonSize))
            {
